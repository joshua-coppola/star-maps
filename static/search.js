!(function () {
  ...
  var e = (function () {
    ...
    i = (function () {
      ...
      return (
        (e.prototype.attach = function (e) {
          (this.fieldEl = t('<input type="text" name="'.concat(this.id, '" id="').concat(this.id, '" value="').concat(this.defaultValue, '" />'))), e.appendChild(this.fieldEl);
        }),
    ...
    s = (function () {
      function e(t, e, i, s) {
        void 0 === s && (s = !0), (this.id = e), (this.label = t), (this.subfields = i), (this.startEnabled = s);
      }
      return (
        (e.prototype.attach = function (e) {
          var i = this;
          (this.labelEl = t('<label class="form-group-label" for="'.concat(this.id, '">').concat(this.label, "</label>"))),
            (this.toggleEl = t('<input class="form-group-checkbox" type="checkbox" id="'.concat(this.id, '" checked="true"/>'))),
            (this.fieldSetEl = t("<fieldset></fieldset>"));
          var s = document.createElement("fieldset");
          s.classList.add("form-group", "big"), s.appendChild(this.labelEl), s.appendChild(this.toggleEl);
          ...
          r.appendChild(s),
            ...
            this.toggleEl.addEventListener("change", function () {
              i.toggleEl.checked ? (i.fieldSetEl.removeAttribute("disabled"), i.labelEl.removeAttribute("disabled")) : (i.fieldSetEl.setAttribute("disabled", "true"), i.labelEl.setAttribute("disabled", "true"));
            }),
        ...
        (e.prototype.evaluate = function () {
          ...
          } else console.warn("FormToggleGroup ".concat(this.id, " not attached"));
        }),
        e
      );
    })(),
      ...
      return (
        (e.prototype.calculateSliderPosition = function (t, e) {
          if (t == 1 / 0) {
            ...
            throw new Error("Default value Infinty too large for ticks ".concat(JSON.stringify(e)));
          }
          if (t < e[0]) throw new Error("Default value ".concat(t, " too small for ticks ").concat(JSON.stringify(e)));
          for (var i = 0; t > e[i + 1] && i < e.length - 1;) i++;
          if (i == e.length - 1) throw new Error("Default value ".concat(t, " too large for ticks ").concat(JSON.stringify(e)));
          var s = e[i];
          return (((t - s) / ((e[i + 1] == 1 / 0 ? 2 * e[i] : e[i + 1]) - s) + i) / (e.length - 1)) * 100;
        }),
        (e.prototype.attach = function (e) {
          (this.sliderLeft = t('<input type="range" value="25" name="'.concat(this.id, '" id="').concat(this.id, '-l" style="opacity: 0; position: fixed; left: -100%;" />'))),
            (this.sliderRight = t('<input type="range" value="75" name="'.concat(this.id, '" id="').concat(this.id, '-r" style="opacity: 0; position: fixed; left: -100%;" />')));
          for (var i = "", s = 0; s < this.settings.steps; s++) {
            var r = "".concat((s / (this.settings.steps - 1)) * 100, "%");
            i += '<rect class="form-slider-tick" x="'.concat(r, '" y="0" width="1" height="15"></rect>');
          }
          var n = "",
            o = [];
          for (s = 0; s < this.settings.steps; s++) {
            ...
            "infinite" == this.settings.type
              ? ((l = this.settings.ticks[s].toString()), o.push(this.settings.ticks[s]))
              : ((l = (((this.settings.start - this.settings.end) / this.settings.steps) * s + this.settings.start).toString()),
                o.push(((this.settings.start - this.settings.end) / this.settings.steps) * s + this.settings.start)),
              "Infinity" == l && (l = "&infin;"),
              0 == s && this.settings.unit && (l += " " + this.settings.unit),
              (n += '<text class="form-slider-text" x="'.concat(r, '" y="27">').concat(l, "</text>"));
          }
          (this.svg = t(
            ...
            (this.rightThumbBorder = this.svg.children[3 + this.settings.steps]),
          ...
          var h = t('<span class="form-slider" for="'.concat(this.id, '"></span>'));
          h.appendChild(this.svg),
            e.appendChild(h),
            e.appendChild(this.sliderLeft),
            e.appendChild(this.sliderRight),
            (this.sliderLeft.valueAsNumber = this.calculateSliderPosition(this.settings.leftDefault, o)),
            (this.sliderRight.valueAsNumber = this.calculateSliderPosition(this.settings.rightDefault, o)),
            this.updateSlider(),
        ...
        (e.prototype.setLeftFocus = function (t) {
          (this.leftFocused = t), this.leftFocused ? this.leftThumbBorder.classList.add("focused") : this.leftThumbBorder.classList.remove("focused");
        }),
        (e.prototype.setRightFocus = function (t) {
          (this.rightFocused = t), this.rightFocused ? this.rightThumbBorder.classList.add("focused") : this.rightThumbBorder.classList.remove("focused");
        }),
        (e.prototype.onMouseDown = function (t) {
          ...
          var e = this.computeSliderValue(t),
            ...
            r = i < s;
          i == s && (r = e < this.sliderLeft.valueAsNumber), r ? (this.sliderLeft.focus(), this.setLeftSlider(e)) : (this.sliderRight.focus(), this.setRightSlider(e));
        }),
        ...
        (e.prototype.setLeftSlider = function (t) {
          t >= this.sliderRight.valueAsNumber && (t = this.sliderRight.valueAsNumber), (this.sliderLeft.valueAsNumber = t), this.updateSlider();
        }),
        (e.prototype.setRightSlider = function (t) {
          t <= this.sliderLeft.valueAsNumber && (t = this.sliderLeft.valueAsNumber), (this.sliderRight.valueAsNumber = t), this.updateSlider();
        }),
        (e.prototype.updateSlider = function () {
          var t = "".concat(this.sliderLeft.value, "%"),
            e = "".concat(this.sliderRight.value, "%"),
            i = "".concat(this.sliderRight.valueAsNumber - this.sliderLeft.valueAsNumber, "%");
        ...
        (e.prototype.calculateActualValue = function (t) {
          if ("finite" == this.settings.type) return (t / 100) * (this.settings.end - this.settings.start);
          var e = Math.floor((t / 100) * (this.settings.steps - 1));
          if (100 == t) return 1 / 0;
          var i = (t / 100 - e / (this.settings.steps - 1)) * (this.settings.steps - 1),
            s = this.settings.ticks[e],
            r = this.settings.ticks[e + 1];
          return r == 1 / 0 ? i * s + s : i * (r - s) + s;
        }),
        (e.prototype.evaluate = function () {
          if (this.sliderLeft && this.sliderRight) return [this.calculateActualValue(this.sliderLeft.valueAsNumber), this.calculateActualValue(this.sliderRight.valueAsNumber)];
          console.warn("FormDoubleEndedSlider ".concat(this.id, " was not attached"));
        }),
        e
      );
    })(),
    n = (function () {
      function t(t, e) {
        (this.thumbBorder = document.createElementNS("http://www.w3.org/2000/svg", "circle")),
          ...
          (this.rectBorder = document.createElementNS("http://www.w3.org/2000/svg", "rect")),
      ...
      return (
        (t.prototype.setFocused = function (t) {
          (this.focused = t), t ? (this.thumbBorder.classList.add("focused"), this.rectBorder.classList.add("focused")) : (this.thumbBorder.classList.remove("focused"), this.rectBorder.classList.remove("focused"));
        }),
        (t.prototype.setValue = function (t) {
          this.thumbBorder.setAttribute("cx", t), this.thumb.setAttribute("cx", t), this.rectBorder.setAttribute("x", t), this.rect.setAttribute("x", t);
        }),
        t
      );
    })(),
    o = (function () {
      function e(t, e) {
        (this.id = t), (this.settings = Object.assign({}, { defaultLeft: 0, defaultRight: 2 }, e));
      }
      return (
        (e.prototype.attach = function (e) {
          (this.svg = t(
            ...
            (this.difficultyBgs = [this.svg.children[0], this.svg.children[1], this.svg.children[2], this.svg.children[3]]),
          ...
          i.appendChild(this.svg),
            (this.sliderLeft = t('<input type="range" id="'.concat(this.id, '-l" name="').concat(this.id, '-l" min="0" max="4" value="0" step="1" style="opacity: 0; position: fixed; left: -100%;" />'))),
            (this.sliderRight = t('<input type="range" id="'.concat(this.id, '-r" name="').concat(this.id, '-r" min="0" max="4" value="3" step="1" style="opacity: 0; position: fixed; left: -100%;" />'))),
            e.appendChild(i),
            e.appendChild(this.sliderLeft),
            e.appendChild(this.sliderRight),
            this.registerEventListeners(),
        ...
        (e.prototype.onMouseDown = function (t) {
          ...
          i == s && (r = e < this.sliderLeft.valueAsNumber),
            ...
            this.thumbLeft.focused ? (this.sliderLeft.valueAsNumber = e) : (this.sliderRight.valueAsNumber = e),
            this.updateSlider();
        }),
        (e.prototype.onMouseMove = function (t) {
          if (this.mouseDown) {
            var e = this.computeFloatingSliderValue(t);
            this.thumbLeft.focused ? (this.sliderLeft.valueAsNumber = e) : (this.sliderRight.valueAsNumber = e), this.updateSlider();
          }
        }),
        (e.prototype.updateSlider = function () {
          this.thumbLeft.setValue(25 * this.sliderLeft.valueAsNumber + "%"), this.thumbRight.setValue(25 * this.sliderRight.valueAsNumber + "%");
          for (var t = this.sliderLeft.valueAsNumber, e = this.sliderRight.valueAsNumber, i = 0; i < this.difficultyBgs.length; i++)
            i >= t && i < e ? this.difficultyBgs[i].classList.remove("inactive") : this.difficultyBgs[i].classList.add("inactive");
        }),
        (e.prototype.evaluate = function () {
          if (this.sliderLeft && this.sliderRight) return [this.sliderLeft.valueAsNumber, this.sliderRight.valueAsNumber];
  ...
  function f() {
    ...
    if ((l.difficulty && ((e.diffmin = d(l.difficulty.d_value[0]).toString()), (e.diffmax = d(l.difficulty.d_value[1]).toString())), l.location && (e.location = l.location.state), l.trail_count)) {
      (e.trailsmin = Math.round(l.trail_count.tc_value[0]).toString()), (e.trailsmax = ((t = l.trail_count.tc_value[1]), t === 1 / 0 ? t : Math.round(t)).toString());
    }
    var i,
      s,
      r =
        ((i = e),
          ...
          Object.keys(i).forEach(function (t) {
            s += "".concat(encodeURIComponent(t), "=").concat(encodeURIComponent(i[t]), "&");
          }),
          s.slice(0, -1));
    location.search = r;
  }
  window.addEventListener("load", function () {
    ...
    g.q && ((n.value = g.q), (h = g.q)), g.sort && g.order && ((u = g.sort), (a = g.order), (d.value = "".concat(u, "-").concat(a)));
    var m = { difficulty: [0, 2], location: { state: "" }, trailCount: [25, 1 / 0] },
      p = !1,
      v = !1,
      b = !1;
    g.diffmin && ((p = !0), (m.difficulty = [c(parseInt(g.diffmin)), c(parseInt(g.diffmax))]), (l.difficulty = { d_value: m.difficulty })),
      g.location && ((v = !0), (m.location.state = g.location), (l.location = { state: m.location.state })),
      g.trailsmin && ((b = !0), (m.trailCount = [parseInt(g.trailsmin), "Infinity" === g.trailsmax ? 1 / 0 : parseInt(g.trailsmax)]), (l.trail_count = { tc_value: m.trailCount }));
    var y = new e(document.getElementById("filters"));
    y.add(new s("Difficulty", "difficulty", [new o("d_value", { defaultLeft: m.difficulty[0], defaultRight: m.difficulty[1] })], p)),
      y.add(new s("State", "location", [new i("state", m.location.state)], v)),
      y.add(new s("Trail Count", "trail_count", [new r("tc_value", { type: "infinite", start: 0, steps: 6, ticks: [0, 25, 50, 100, 200, 1 / 0], leftDefault: m.trailCount[0], rightDefault: m.trailCount[1] })], b)),
